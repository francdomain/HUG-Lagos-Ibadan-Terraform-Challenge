...
- Screenshot of the AWS EC2 console showing the running instance (`screenshots/ec2.png`)

![alt text](./screenshots/ec2.png)

- Screenshot of the AWS RDS console showing the running database instance (`screenshots/rds.png`)

![alt text](./screenshots/rds.png)

- Screenshot of the HTML landing page (`screenshots/webpage.png`)
